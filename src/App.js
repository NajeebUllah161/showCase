...
const App = () => {
  return (
    <>
      <SectionWrapper
        title="Your own store of Nafty NFT's.
      ...
      <SectionWrapper
        ...
        description="Experience a buttery UI of ProNet NFT Marketplace. Smooth constant 
      ...
      />
      <Download />
      <div className='px-4 py-2 justify-center items-center bg-primary text-center flex-col banner04'>
        <p className={`${styles.pText} ${styles.whiteText}`}>
          Made with love by {" "}
          <span className='bold'>Najeeb Ullah Khan ©</span>
        </p>
      </div>
    </>
  );
